...
export const survivalCharacters: Record<SurvivalType, SurvivalCharacter> = {
  instinct: {
    ...
    slug: "wolf",
    emblem: "🐺",
    imagePath: "/assets/survival-wolf.png",
  ...
  strategic: {
    ...
    slug: "owl",
    emblem: "🦉",
    imagePath: "/assets/survival-owl.png",
    accent: "survival-owl",
    title: "상황 파악이 먼저인 타입",
  ...
  avoidant: {
    ...
    slug: "rabbit",
    emblem: "🐰",
    imagePath: "/assets/survival-rabbit.png",
  ...
  endure: {
    ...
    slug: "bear",
    emblem: "🐻",
    imagePath: "/assets/survival-bear.png",
  ...
  impulsive: {
    ...
    slug: "monkey",
    emblem: "🐒",
    imagePath: "/assets/survival-monkey.png",
  ...
  calculated: {
    ...
    slug: "fox",
    emblem: "🦊",
    imagePath: "/assets/survival-fox.png",
    accent: "survival-fox",
  ...
  dependent: {
    ...
    slug: "dog",
    emblem: "🐶",
    imagePath: "/assets/survival-dog.png",
    accent: "survival-dog",
  ...
  panic: {
    ...
    slug: "octopus",
    emblem: "🐙",
    imagePath: "/assets/survival-octopus.png",
