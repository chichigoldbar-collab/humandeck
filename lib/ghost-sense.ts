...
export const ghostProfiles: Record<GhostResultType, GhostProfile> = {
  instinctWolf: {
    ...
    slug: "wolf",
    emblem: "🐺",
    imagePath: "/assets/ghost-wolf.png",
    accent: "ghost-wolf",
  ...
  numbBear: {
    ...
    slug: "bear",
    emblem: "🐻",
    imagePath: "/assets/ghost-bear.png",
    accent: "ghost-bear",
  ...
  immersiveCat: {
    ...
    slug: "cat",
    emblem: "🐱",
    imagePath: "/assets/ghost-cat.png",
    accent: "ghost-cat",
  ...
  suspiciousOwl: {
    ...
    slug: "owl",
    emblem: "🦉",
    imagePath: "/assets/ghost-owl.png",
    accent: "ghost-owl",
    headline: "계속 확인하는 타입",
  ...
  sensingFox: {
    ...
    slug: "fox",
    emblem: "🦊",
    imagePath: "/assets/ghost-fox.png",
    accent: "ghost-fox",
  ...
  rationalAnt: {
    ...
    slug: "ant",
    emblem: "🐜",
    imagePath: "/assets/ghost-ant.png",
    accent: "ghost-ant",
