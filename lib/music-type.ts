...
export const musicCharacters: Record<MusicType, MusicCharacter> = {
  emotional: {
    ...
    slug: "whale",
    emblem: "🐋",
    imagePath: "/assets/music-whale.svg",
    accent: "music-whale",
  ...
  stimulus: {
    ...
    slug: "cheetah",
    emblem: "🐆",
    imagePath: "/assets/music-cheetah.svg",
  ...
  focus: {
    ...
    slug: "owl",
    emblem: "🦉",
    imagePath: "/assets/music-owl.svg",
    accent: "music-owl",
  ...
  nostalgia: {
    ...
    slug: "otter",
    emblem: "🦦",
    imagePath: "/assets/music-otter.svg",
    accent: "music-otter",
  ...
  background: {
    ...
    slug: "capybara",
    emblem: "🐿",
    imagePath: "/assets/music-capybara.svg",
  ...
  curation: {
    ...
    slug: "fox",
    emblem: "🦊",
    imagePath: "/assets/music-fox.svg",
    accent: "music-fox",
  ...
  spontaneous: {
    ...
    slug: "rabbit",
    emblem: "🐰",
    imagePath: "/assets/music-rabbit.svg",
    accent: "music-rabbit",
  ...
  immersive: {
    ...
    slug: "wolf",
    emblem: "🐺",
    imagePath: "/assets/music-wolf.svg",
    accent: "music-wolf",
