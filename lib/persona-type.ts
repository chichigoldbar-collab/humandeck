...
export const personaCharacters: Record<PersonaType, PersonaCharacter> = {
  coping: {
    ...
    slug: "fox",
    emblem: "🦊",
    imagePath: "/assets/persona-fox.svg",
    accent: "persona-fox",
  ...
  pleasing: {
    ...
    slug: "deer",
    emblem: "🦌",
    imagePath: "/assets/persona-deer.svg",
    accent: "persona-deer",
  ...
  aloof: {
    ...
    slug: "cat",
    emblem: "🐱",
    imagePath: "/assets/persona-cat.svg",
    accent: "persona-cat",
  ...
  competent: {
    ...
    slug: "lion",
    emblem: "🦁",
    imagePath: "/assets/persona-lion.svg",
    accent: "persona-lion",
  ...
  cheerful: {
    ...
    slug: "monkey",
    emblem: "🐵",
    imagePath: "/assets/persona-monkey.svg",
  ...
  dominant: {
    ...
    slug: "wolf",
    emblem: "🐺",
    imagePath: "/assets/persona-wolf.svg",
    accent: "persona-wolf",
  ...
  defensive: {
    ...
    slug: "hedgehog",
    emblem: "🦔",
    imagePath: "/assets/persona-hedgehog.svg",
  ...
  performative: {
    ...
    slug: "peacock",
    emblem: "🦚",
    imagePath: "/assets/persona-peacock.svg",
