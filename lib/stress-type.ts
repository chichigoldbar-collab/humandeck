...
export const stressResults: Record<StressResultType, StressResultProfile> = {
  avoidSloth: {
    ...
    slug: "sloth",
    emblem: "🦥",
    imagePath: "/assets/stress-sloth.svg",
    accent: "stress-sloth",
  ...
  releasePanda: {
    ...
    slug: "panda",
    emblem: "🐼",
    imagePath: "/assets/stress-panda.svg",
    accent: "stress-panda",
  ...
  solveWolf: {
    ...
    slug: "wolf",
    emblem: "🐺",
    imagePath: "/assets/stress-wolf.svg",
    accent: "stress-wolf",
  ...
  scatterMonkey: {
    ...
    slug: "monkey",
    emblem: "🐒",
    imagePath: "/assets/stress-monkey.svg",
  ...
  overthinkFox: {
    ...
    slug: "fox",
    emblem: "🦊",
    imagePath: "/assets/stress-fox.svg",
    accent: "stress-fox",
  ...
  burstBoar: {
    ...
    slug: "boar",
    emblem: "🐗",
    imagePath: "/assets/stress-boar.svg",
    accent: "stress-boar",
  ...
  neglectPenguin: {
    ...
    slug: "penguin",
    emblem: "🐧",
    imagePath: "/assets/stress-penguin.svg",
