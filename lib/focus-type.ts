...
export const focusResults: Record<FocusResultType, FocusResultProfile> = {
  focusOwl: {
    ...
    slug: "owl",
    emblem: "🦉",
    imagePath: "/assets/focus-owl.png",
    accent: "focus-owl",
  ...
  multiMonkey: {
    ...
    slug: "monkey",
    emblem: "🐒",
    imagePath: "/assets/focus-monkey.png",
    accent: "focus-monkey",
  ...
  scatterButterfly: {
    ...
    slug: "butterfly",
    emblem: "🦋",
    imagePath: "/assets/focus-butterfly.png",
  ...
  balancedDolphin: {
    ...
    slug: "dolphin",
    emblem: "🐬",
    imagePath: "/assets/focus-dolphin.png",
  ...
  impulseDog: {
    ...
    slug: "dog",
    emblem: "🐶",
    imagePath: "/assets/focus-dog.png",
    accent: "focus-dog",
